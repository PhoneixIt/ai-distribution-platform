      ...
      <div className="mx-auto max-w-7xl px-5 py-14 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-md text-sm leading-7 text-slate-500">The AI operating platform for software distribution and channel businesses. Connect the business system, intelligence and AI workforce in one operating model.</p>
          </div>
          <div>
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-slate-900 pt-6 text-xs text-slate-600 sm:flex-row sm:items-center sm:justify-between">
          ...
          <span>People manage the business. AI operates the work.</span>
        </div>
      </div>
    </footer>
  )
