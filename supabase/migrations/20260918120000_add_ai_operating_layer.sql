...
values
  ('ceo_orchestrator', 'Distributor CEO / Orchestrator',
   ...
   array['query_partners','query_vendors','query_products','query_customers','query_opportunities','query_activities','query_tasks','query_pricing','query_partner_performance','search_market','analyze_opportunity','generate_recommendation'],
  ...
  ('vendor_manager', 'Vendor Manager Agent',
   ...
   array['query_vendors','query_products','search_market','generate_recommendation'],
  ...
  ('partner_manager', 'Partner Manager Agent',
   ...
   array['query_partners','query_partner_performance','query_activities','query_tasks','generate_recommendation'],
  ...
  ('sales_agent', 'Sales Agent',
   ...
   array['query_opportunities','query_customers','query_partners','query_activities','analyze_opportunity','generate_recommendation'],
  ...
  ('market_intelligence', 'Market Intelligence Agent',
   ...
   array['search_market','query_vendors','query_products','query_partners','generate_recommendation'],
  ...
  ('commercial_agent', 'Commercial Agent',
   ...
   array['query_pricing','query_opportunities','analyze_opportunity','generate_recommendation'],
  ...
  ('operations_agent', 'Operations Agent',
   ...
   array['query_tasks','query_activities','query_opportunities','query_partners','generate_recommendation'],
